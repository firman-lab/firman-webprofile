                                    ...
                                    <div className='w-full lg:w-7/12'>
                                        ...
                                        <div className='text-xs tracking-tighter sm:text-sm mt-4'>
                                            ...
                                            <div className='text-xs text-slate-500 dark:text-slate-400 flex flex-col gap-y-2 [&_svg]:inline [&_svg]:w-4 [&_svg]:h-4 md:[&_svg]:w-5 md:[&_svg]:h-5 [&_svg]:stroke-1 [&_svg]:mr-2'>
                                                <p>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-clock-2" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <section className='col-span-10 col-start-2'>
                                <div className='flex items-center gap-x-2'>
                                    <a className='font-semibold text-invert whitespace-nowrap gap-x-2 items-center sm:inline-flex hidden' href={'/'}>F-Blog
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 inline" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><polyline points="9 6 15 12 9 18"></polyline></svg>
                                    </a>
