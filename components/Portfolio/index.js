...
export default function Portfolio() {
    return (
        <section className='container py-8 lg:py-12 xl:py-16 mx-auto mb-8'>
            ...
            <div className='px-8'>
                <h3 className='text-2xl lg:text-3xl xl:text-4xl text-center font-bold text-transparent bg-clip-text dark:bg-gradient-to-r dark:from-[#29af77] dark:to-[#53e0a1] bg-[#26a76d] drop-shadow-md !leading-normal'>Selected Project</h3>
