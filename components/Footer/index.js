...
export default function footer() {
    return (
        <footer className='py-6 lg:py-8 xl:pt-16 bg-gradient-to-tr  from-indigo-900 to-purple-800 dark:bg-slate-800'>
            ...
            <div className='mt-8 pt-8 border-t border-slate-600/60 borderw text-center text-white flex flex-row justify-center items-center '>
